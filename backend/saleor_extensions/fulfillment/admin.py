...
class ClickAndCollectOrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Order Information", {"fields": ("order", "branch", "status")}),
        ("Customer Information", {"fields": ("customer_name", "customer_phone", "customer_email")}),
        ("Pickup Details", {"fields": ("ready_at", "picked_up_at", "expiry_date", "prepared_by", "collected_by")}),
...
class ShipmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Shipment Information", {"fields": ("fulfillment", "get_order_id", "branch", "shipment_type", "status")}),
        ("Courier Details", {"fields": ("courier_name", "courier_service", "tracking_number", "tracking_url")}),
        ("Shipping Details", {"fields": ("shipping_address", "shipping_cost")}),
        ("Delivery Information", {"fields": ("dispatched_at", "estimated_delivery", "delivered_at")}),
        ("Additional Information", {"fields": ("notes",)}),
        ("Timestamps", {"fields": ("created_at", "updated_at")}),
    )
